...
!> @details
!! Save order parameter, pressure, and velocity data in VTK format for the dual
!! grid parallel D2Q5/D2Q9 Zheng-Shu-Chew multiphase LBM. Filenames are
...
! Common Variables
 USE Domain,      ONLY : NX, NY, iStep, xl, xu, yl, yu
