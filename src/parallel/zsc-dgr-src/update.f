...
!-------------------------------------------------------------------------------
!> @file
!! Bilinear interpolation of velocity and pressure in the order parameter grid.
!> @details
!! Update velocity and pressure in the order parameter grid using a bilinear
!! interpolation of the values on the momentum grid for the dual grid parallel
