...
!! D2Q9 Lee-Lin multiphase LBM. Filenames are 'DATA_XXXXXXX.VTK'
...
! Author   : David S. Whyte [david(at)ihpc.a-star.edu.sg]
!-------------------------------------------------------------------------------
!> @brief Set vtk file name as a function of the time step
!> @details
 FUNCTION filer()
